...
import { RegistrationDto, LogoutDto, LoginDto } from './dto';
...
export class AuthService {
    ...
    async logout(dto: LogoutDto, res: Response) {
        ...
        await this.findSessionById(sessionId, { user: { select: { id: true } } })
